...
function seeRecentChanges( $staff_id, $limit = 10 ) {
	...
	if ( $staff_id ) {
        ...
        GROUP BY record_title, message, ourtable, record_id, date_added
        ORDER BY date_added DESC
        LIMIT 0, $limit";
	} else {
        ...
        GROUP BY record_title, message, ourtable, record_id, date_added, CONCAT( fname, ' ', lname )
        ORDER BY date_added DESC
        LIMIT 0 , $limit";
	}
